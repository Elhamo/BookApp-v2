// Demo Zahnarztpraxis Data
// Terminbuchungssystem - Demo Version

export const demoConfig = {
  id: 'zahnarztpraxis-demo-2025',
  name: 'Dr. Michael Weben',
  description: 'Zahn-, Mund- und Kieferheilkunde',
  location: 'Musterstraße 123, 1010 Wien',
  phone: '+43 1 234 5678',
  email: 'ordination@ihre-praxis.at',
  ...
  // Sprachen des Arztes
  languages: [
    { id: 'de', name: 'Deutsch', flag: '🇩🇪', doctors: ['dr-weben'] },
    { id: 'en', name: 'English', flag: '🇬🇧', doctors: ['dr-weben'] }
  ],
